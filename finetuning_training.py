...
D = Discriminator(dataset.__len__(), path_to_Wi, finetuning=True)
...
for epoch in range(num_epochs):
    for i_batch, (pose_aug, pose_img, pose_seg) in enumerate(dataLoader):
        ...
        with torch.autograd.enable_grad():
            ...
            r_hat, D_hat_res_list = D(x_hat, e_finetuning=ei_hat, i=0)
            with torch.no_grad():
                r, D_res_list = D(x, e_finetuning=ei_hat, i=0)
